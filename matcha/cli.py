...
def run_matcha(
    ...
    analogue_unconstrained_supplement: bool = typer.Option(False, "--analogue-unconstrained-supplement/--no-analogue-unconstrained-supplement", help="Supplement coord-map constrained seeds with unconstrained ETKDG seeds aligned to the MCS core."),
    ...
    analogue_unconstrained_supplement = _option_default(analogue_unconstrained_supplement, False)
